...
function SharedWorkflowInner({ workflowId }: { workflowId: string }) {
...
export default function SharedWorkflowClient({ workflowId }: { workflowId: string }) {
    return (
        <ReactFlowProvider>
            <SharedWorkflowInner workflowId={workflowId} />
        </ReactFlowProvider>
    )
}
