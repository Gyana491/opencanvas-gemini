...
export const GeminiFlashNode = memo(({ data, selected }: any) => {
      ...
      <div className="p-3">
        ...
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center gap-2">
            ...
            <h3 className="font-semibold text-sm">Gemini 2.5 Flash Lite</h3>
          </div>
...
GeminiFlashNode.displayName = 'GeminiFlashNode'
